...
## Files
- `Kennedy Portfolio.dc.html` — the design reference. Open directly in a browser to inspect the layout and interactions. All styling is inline; measurements, colors, and copy in the file are the source of truth.
